...
?>
    ...
    <a href="./calcendar2.php?month=<?=$cumon;?>&year=<?=$cuyear-1;?>">前一年 </a>
    <a href="./calcendar2.php?month=<?=$cumon-1;?>&year=<?=$cuyear;?>">前一月 </a>
    <a href="./calcendar2.php?month=<?=$cumon+1;?>&year=<?=$cuyear;?>">後一月 </a>
    <a href="./calcendar2.php?month=<?=$cumon;?>&year=<?=$cuyear+1;?>">後一年</a>
     ...
     For ($i=0; $i < 6; $i++) { 
        ...
        for ($wday=0; $wday < 7; $wday++) { 
            ...
            if($taiwan_calendar==1)        
                {
                    if(!$hday)
                        $hday=($data_day[$dayOfYear]['description'])?"holiday ":""; 
                }
            echo "<td class='".$tdhday."'>";            
            echo "<div class='".$normalday.$hday.$gday.$tday."'>".$run_day->Format('j')."</div>";
