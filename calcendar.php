...
if (isset($_GET['month']) && isset($_GET['year'])) {
    ...
    $today=new Datetime();
    $currentYear=$fday_mon->format("Y");
    $currentMonth=$fday_mon->format("m");
}
   ...
   // $today=new Datetime();
    ...
    <a href="calendat2.php?month=-1">上個月</a> -->
    <a href="calcendar.php?month=<?php echo $currentMonth ; ?>&year=<?php echo $currentYear-1; ?>">前一年 </a>        
    <a href="calcendar.php?month=<?php echo $currentMonth - 1; ?>&year=<?php echo $currentYear; ?>">上個月 </a>
    <a href="calcendar.php?month=<?php echo $currentMonth + 1; ?>&year=<?php echo $currentYear; ?>">下個月 </a>
    <a href="calcendar.php?month=<?php echo $currentMonth ; ?>&year=<?php echo $currentYear+1; ?>">下一年 </a>    
    ...
    for ($i=0; $i < 6; $i++) { 
        ...
        for ($j=0; $j<7; $j++){ 
            ...
            $g_str=($run_day->format('Y-m')!=$fday_mon->format('Y-m'))?"grey-text ":"";
        ...
        echo "</tr>";
        if(($i==4)&&($run_day->format('Y-m')!=$fday_mon->format('Y-m')))
            break;
